...
import { getAssistantRenderer } from "../../forked/core/lib/diagnostic.js";
...
export function AssistantEntry({
  ...
  //    OPENTUI_ASSISTANT_RENDERER=code flag.
  //
  // 2) reserveHeightWhileStreaming = entry.assistantStreaming (the REAL state)
  //    The per-width monotonic height floor (a  patch — opencode has no such
