...
import { getSwarmflowAssistantRenderer } from "../../forked/core/lib/diagnostic.js";
...
export function AssistantEntry({
  ...
  // them back into one 鈥?they fix two different things and pull in opposite ways.
  //
  ...
  //    repaint 鈥?a full-viewport flicker at the end of EVERY turn. Keeping it true
  ...
  //    SWARMFLOW_OPENTUI_ASSISTANT_RENDERER=code flag.
  //
  // 2) reserveHeightWhileStreaming = entry.assistantStreaming (the REAL state)
  //    The per-width monotonic height floor (a swarmflow patch 鈥?opencode has no such
  ...
  //    (b) makes a block's height non-monotonic in width 鈥?at some widths
